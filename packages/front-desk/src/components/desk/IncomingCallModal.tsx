...
export default function IncomingCallModal({
  ...
  const peerName = currentCall.fromName;
  const peerExt = currentCall.fromExt;
  ...
  return createPortal(
    ...
    >
      ...
      <div className="w-full max-w-xs landscape:max-w-none landscape:w-auto flex items-end landscape:items-center justify-between landscape:justify-center landscape:gap-8 gap-12 mb-2 landscape:mb-0 shrink-0">
        <div className="flex flex-col items-center gap-2 landscape:gap-1.5">
          ...
          <span className="text-sm font-medium text-blue-100 short-landscape:hidden">Decline</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 landscape:gap-1.5">
          <button
            ...
            className="call-btn-size rounded-full bg-emerald-500 hover:bg-emerald-600 flex items-center justify-center shadow-xl transition-all active:scale-95 blink-emerald"
          >
            <Phone className="w-6 h-6 landscape:w-7 landscape:h-7" />
          </button>
          <span className="text-sm font-medium text-blue-100 short-landscape:hidden">Answer</span>
        </div>
      </div>
    </div>,
    document.body,
