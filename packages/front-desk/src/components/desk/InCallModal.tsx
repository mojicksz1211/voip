...
export default function InCallModal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[190] flex flex-col items-center justify-between select-none animate-fadeIn bg-gradient-to-b from-[#0a1f44] via-[#0b1e3f] to-[#08152e] text-white px-6 pt-16 pb-10"
      role="dialog"
      aria-modal="true"
