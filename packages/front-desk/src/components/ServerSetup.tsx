...
export default function ServerSetup({ onSaved, onCancel }: ServerSetupProps) {
  ...
  return (
    <div className="h-full bg-desk-surface flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-200 desk-shadow-elevated p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Link this tablet to the hotel network</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={testing}
            className="w-full py-3 bg-desk-primary hover:bg-desk-primary-dark disabled:bg-slate-300 text-white font-bold rounded-xl flex items-center justify-center gap-2"
          >
